...
public class DataLoadRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Movie m1 = new Movie("Everything Everywhere all at once", "Daniels", 140, false, false, false, false, false, true, "https://pokeapi.co/api/v2/berry-firmness/2/");
        Movie m2 = new Movie("Cena con delitto - Knives out", "Rian Johnson", 130, false, true, true, false, false, true, "https://pokeapi.co/api/v2/berry/64/");
        Movie m3 = new Movie("Avatar - La via dell'acqua", "James Cameron", 192, true, true, true, false, false, true, "https://pokeapi.co/api/v2/berry/64/");
